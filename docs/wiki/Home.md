...
Merchant acquiring pre-boarding suite: one intake → 14 deterministic checks grouped under four
rule-based agents → Approve / Refer / Decline with full explainability, a PDF memo and an audit trail.
